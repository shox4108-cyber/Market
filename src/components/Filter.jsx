...
import {
  getCategories,
  getCurrentCategory,
} from "../store/categoryList/categoryListSlice";
import { filterABC, filterCategory, getProducts } from "../store/products/productsSlice";
...
const Filter = () => {
  ...
  const clear = () => {
    ...
    dispatch(getCurrentCategory("All Products"));
        ...
        <div className={s.filter__category}>
          ...
          <div className={s.filter__category_box}>
            <div
              ...
              onClick={() => {handleClick("All Products"), dispatch(getProducts(''))}}
            >
              All Products
            </div>
            {categories &&
        ...
        <div className={s.filter__sort}>
          ...
          <form className={s.filter__sort_box} onChange={handleChange}>
            <div className={s.filter__sort_item}>
              <input type="radio" name="sort" id="asc" value="asc" checked={sort === "asc"} />
              <label for="asc">Name A-Z</label>
            </div>
            <div className={s.filter__sort_item}>
              <input type="radio" name="sort" id="desc" value="desc" checked={sort === "desc"}/>
